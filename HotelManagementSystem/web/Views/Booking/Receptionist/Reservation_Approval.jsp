                ...
                <body>
                    <header>
                        ...
                        <div class="header-right">
                            <div class="nav-links">
                                ...
                                <a href="${pageContext.request.contextPath}/reservation_approval">Approve</a>
                            ...
                            <c:choose>
                                <c:when test="${empty pendingBookings}">
                                    <div class="empty-state">
                                        ...
                                        <p style="color: #999; margin-top: 10px;">All reservations have been processed.
                                        </p>
                                    </div>
                                </c:when>
                                <c:otherwise>
                                    <p style="margin-bottom: 20px; color: #777; font-size: 15px;">
                                        <strong style="color: #1e3c72;">${fn:length(pendingBookings)}</strong> pending
                                        reservations
                                    </p>
                                        ...
                                        <c:forEach var="booking" items="${pendingBookings}">
                                            <div class="reservation-card">
                                                <div class="reservation-header">
                                                    ...
                                                    <span class="reservation-status">PENDING APPROVAL</span>
                                                </div>
                                                <div class="reservation-body">
                                                    ...
                                                    <table class="info-table" style="border-bottom: none;">
                                                        <tr>
                                                            <td style="font-weight: 700; color: #e67e22;">Total Amount:
                                                            </td>
                    ...
                    <div id="rejectModal" class="modal">
                        <div class="modal-content">
                            <div class="modal-header">Reject Reservation</div>
                            ...
                            <div class="modal-buttons">
                                <button class="btn btn-reject" onclick="submitReject()">Confirm Rejection</button>
                    ...
                    <script>
                        ...
                        function approveBooking(bookingId) {
                            if (confirm('Confirm approval for booking BK-' + bookingId + '?')) {
